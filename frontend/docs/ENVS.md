...
| NEXT_PUBLIC_TOP_ACCOUNTS_EXCLUDED_ADDRESSES | `Array<string>` | Hex addresses to omit from the Top accounts list (e.g. burn/treasury). Case-insensitive. | - | `[]` | `'["0x000000000000000000000000000000000000dEaD"]'` | Mars Credit+ |
