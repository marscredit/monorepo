-- Pilot version of ethereum_eoa_top35k.sql — LIMIT 100 to estimate Dune credit cost.
-- Addresses are varbinary on Dune — do not use LOWER(); compare as 0x literals.
